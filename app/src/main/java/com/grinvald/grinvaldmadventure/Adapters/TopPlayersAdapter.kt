...
class TopPlayersAdapter(questsList: MutableList<Profile>, context: Context) : RecyclerView.Adapter<TopPlayersAdapter.Holder>() {
    ...
    override fun onBindViewHolder(holder: Holder, position: Int) {
        ...
        var rating = quest.userRating.toDouble().roundToInt()
